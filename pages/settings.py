...
with col1:
    if user_choice == 1:
        st.radio(label='Plant 1', options=['One', 'Plant 1'], index=2, label_visibility='collapsed')
    else: 
...
with col2:
    if user_choice == 2:
        st.radio(label='Plant 2', options=['One', 'Plant 2'], index=2, label_visibility='collapsed')
    else: 
        st.radio(label='Plant 2', options=['One', 'Plant 2'], label_visibility='collapsed')

with col3:
    if user_choice == 3:
        st.radio(label='Plant 3', options=['One', 'Plant 3'],index=2, label_visibility='collapsed')
    else: 
        st.radio(label='Plant 3', options=['One', 'Plant 3'], label_visibility='collapsed')

with col4:
    if user_choice == 3:
        st.radio(label='Customize', options=['One', 'Customize'], index=2, label_visibility='collapsed')
    else: 
